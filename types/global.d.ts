...
declare module 'gstc' {
  ...
  export type ColumnDataFunctionString = ({ row: Row, vido: Vido }: { row: any; vido: any }) => string;
  export type ColumnDataFunctionTemplate = ({ row: Row, vido: Vido }: { row: any; vido: any }) => htmlResult;
